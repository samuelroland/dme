...
use preview::{
    comrak::highlight_code_from_cached_highlighter,
    tree_sitter_grammars::TreeSitterGrammarsManager, tree_sitter_highlight::TreeSitterHighlighter,
};
...
///
/// Code is actually highlighted only if feature flag `colored-code` is enabled !
...
![something](yep-here.svg "with figure caption !")
...
<p></p><figure><img src="test.svg" alt="a"></figure><p></p>
<p></p><figure><img src="yep-here.svg" alt="something" title="with figure caption !"><figcaption>with figure caption !</figcaption></figure><p></p>
