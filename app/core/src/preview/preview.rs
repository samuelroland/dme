...
mod tests {
    ...
    fn test_images_path_can_be_left_untouched() {
        ...
        assert_eq!(
            result,
            format!("<h1><a href=\"#sky\" rel=\"noopener noreferrer\"></a>Sky</h1>\n<p><img src=\"sky.png\" alt=\"super sky\"></p>\n")
        );
    }
...
![nice path](../images-de-fous/super_Schema$BIEN3joli.png)";
        ...
        assert_eq!(
            result,
            format!(
                "<h1><a href=\"#sky\" rel=\"noopener noreferrer\"></a>Sky</h1>
...
Circular of a circle: $P = 2 pi r$"#;
        let expected = r##"<h1><a href="#circle" rel="noopener noreferrer"></a>Circle</h1>
...
Yop $$G &= mat(
  ...
  1, 1
        ...
        let expected = r##"<h1><a href="#nice-matrix" rel="noopener noreferrer"></a>Nice matrix</h1>
