...
pub struct Html {
    ...
    pub(crate) image_rewrite: ImageUrlRewriteMode,
}
...
impl Html {
    ...
    pub fn to_safe_html_string(&self) -> String {
        ...
        {
            let mut cleaner = self.build_html_sanitizer();
            self.setup_image_urls_rewrite(&mut cleaner);
            let final_html = &cleaner.clean(&self.content).to_string();
            format!("{}{}", style_markup, final_html)
        }
        #[cfg(not(feature = "security"))]
        format!("{}{}", style_markup, self.content)
    }
